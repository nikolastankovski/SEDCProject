...
//--------------------------------------------------------
(() => {
    document.getElementById("total-customers").textContent = data.length; // Fill Total Clients
    sortData("date", "desc"); // initial sort by date
    generateTable(data); // initial draw table
})();
//--------------------------------------------------------
...
function generateTable(data) {
  ...
  tbody.classList.add("tbodyActive");
  tbody.innerHTML = "";
...
fillProgressBar();
>>>>>>> 0a1cdd922baf5484a1406a053434a36b2584bd04
